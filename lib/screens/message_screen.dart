...
//TODO 29: Import cloud firestore, firebase auth, intl, scaffold gradient
    ...
    return SafeArea(
      child: ScaffoldGradientBackground(
        ...
        body: StreamBuilder<QuerySnapshot>(
            stream: 
            //TODO 32: Provide messages stream ordered by 'Time' parameter
            ,
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                ...
                //TODO 33: Create messages List<DocumentSnapshot>
                return Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: ListView.separated(
                          itemBuilder: (context, index) {
                            //TODO 37: Return Message Bubble widget with username, message, current user or not, and photo url
